...
FROM 
    ...
    INNER JOIN zuber_trips ON zuber_trips.cab_id = zuber_cabs.cab_id
WHERE 
    TRUNC(zuber_trips.start_ts) BETWEEN TO_DATE('2017-11-01', 'YYYY-MM-DD') 
...
WHERE 
    zuber_trips.pickup_location_id = 50 AND zuber_trips.dropoff_location_id = 63 AND EXTRACT(DOW FROM TO_TIMESTAMP(zuber_trips.start_ts, 'YYYY-MM-DD HH24:MI:SS')) = 6
